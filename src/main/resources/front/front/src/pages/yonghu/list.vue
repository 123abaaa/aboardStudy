...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","margin":"0 auto","borderColor":"#F56C6C","alignItems":"center","display":"flex","borderRadius":"0 0 12px 12px","flexWrap":"wrap","background":"#fbf9f3","borderWidth":"0 1px 1px 1px","width":"1200px","borderStyle":"solid","height":"auto","order":"2"}'>
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>Account</div>
        <el-input v-model="formSearch.zhanghao" placeholder="Account" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>name</div>
        <el-input v-model="formSearch.xingming" placeholder="name" clearable></el-input>
      </el-form-item>
	...
	<div class="list" :style='{"width":"100%","margin":"0","background":"none","order":"3"}'>
		...
		<div class="list1 index-pv1" :style='{"border":"1px solid #F56C6C","padding":"30px 20px 20px","boxShadow":"0px 0px 0px #ddd,inset 0px 0px 30px 0px #fbf5db","margin":"20px 0 0 0","borderRadius":"16px","flexWrap":"wrap","background":"#fff","display":"flex","width":"calc(100% - 2px)","justifyContent":"space-around","height":"auto"}'>
			<div :style='{"margin":"0 0 30px","borderRadius":"8px","background":"none","display":"inline-block","width":"32%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"cursor":"pointer","padding":"8px","borderColor":"#F56C6C","objectFit":"cover","borderRadius":"20%","borderWidth":"3px","background":"#FEDCD2","display":"block","width":"100%","borderStyle":"dotted dashed solid double","height":"274px"}' v-if="item.touxiang && item.touxiang.substr(0,4)=='http'" :src="item.touxiang" class="image" />
				<img :style='{"cursor":"pointer","padding":"8px","borderColor":"#F56C6C","objectFit":"cover","borderRadius":"20%","borderWidth":"3px","background":"#FEDCD2","display":"block","width":"100%","borderStyle":"dotted dashed solid double","height":"274px"}' v-else :src="baseUrl + (item.touxiang?item.touxiang.split(',')[0]:'')" class="image" />
				...
				<div :style='{"padding":"0 10px","boxShadow":"0px 2px 0px #FEDCD2","margin":"4px auto 0 auto","whiteSpace":"nowrap","color":"#333","textAlign":"center","overflow":"hidden","borderRadius":"20% ","background":"#f6f6f6","width":"76%","lineHeight":"30px","fontSize":"14px","textOverflow":"ellipsis"}' class="name ">{{item.xingming}}</div>
			</div>
		</div>

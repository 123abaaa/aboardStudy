...
<div :style='{"border":"1px solid #ddd","padding":"20px","margin":"20px auto 0","borderRadius":"16px","background":"#fff","width":"1200px","position":"relative"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"linear-gradient(180deg, rgba(254,215,217,1) 0%, rgba(254,215,217,1) 51%, rgba(255,182,193,1) 51%, rgba(255,182,193,1) 100%)"}' label="name" prop="name">
            <el-input v-model="ruleForm.name" 
                placeholder="name" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"linear-gradient(180deg, rgba(254,215,217,1) 0%, rgba(254,215,217,1) 51%, rgba(255,182,193,1) 51%, rgba(255,182,193,1) 100%)"}' label="value" prop="value">
            <file-upload

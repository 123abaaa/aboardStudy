  ...
  <el-card style="width: 60%; margin: 30px auto 0px auto;">
    <el-form :inline="true" :model="formSearch" class="list-form-pv">
      <div class="section-btn">
        ...
        <el-button type="primary" @click="getForumList(1)"><i class="el-icon-search"></i>query</el-button>
        <el-button type="primary" icon="el-icon-plus" @click="toForumAdd">Post</el-button>
      </div>
    </el-form>
    <div class="z-box">
      <div class="section-content" v-for="item in forumList" :key="item.id" @click="toForumDetail(item)">
        <div class="item-style">{{item.title}}（Publisher：{{item.username}}）</div>
...
<script>
  export default {
    ...
    methods: {
      getForumList(page) {
        let params = {page, limit: this.pageSize, isdone: 'Open', sort: 'addtime', order: 'desc'};
        let searchWhere = {};

		...
		<template v-if="showFlag">
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false' prop="value" width="200" label="value">
						<template slot-scope="scope">
					...
					<el-table-column width="300" label="operation">
						<template slot-scope="scope">
							<el-button :style='{"border":"1px solid #AAAAAA","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#AAAAAA","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('config','check')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">details</el-button>
							<el-button :style='{"border":"1px solid #AAAAAA","cursor":"pointer","padding":"0 24px","margin":"0 10px 5px 0","outline":"none","color":"#AAAAAA","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('config','modify')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">modify</el-button>

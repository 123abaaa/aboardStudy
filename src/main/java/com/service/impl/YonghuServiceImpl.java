...
public class YonghuServiceImpl extends ServiceImpl<YonghuDao, YonghuEntity> implements YonghuService {
	...
	@Override
	public YonghuEntity findYonghuEntityByAccountEmail(Map<String, String> params) {
		return baseMapper.findYonghuEntityByAccountEmail(params);
	}

	@Override
	public int fotgotPassword(Map<String, String> params) {
		return baseMapper.fotgotPassword(params);
	}
